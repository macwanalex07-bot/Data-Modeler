...
⚠️ **Note:** No DAX, calculated columns, or charts are used. All logic is implemented using **Power Query** and **Model View** only. A **Matrix visual** is used strictly for relationship verification.
...
### ❄️ Snowflake / Secondary Fact Modeling
